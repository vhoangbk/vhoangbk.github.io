  ...
  constructor({
    ...
    let template = `
      <div class="dialog-video-player-box">
        <video class="dialog-video-player-player" controls src="${decodeURIComponent(blob_url)}"></video>
        <svg class="dialog-video-player-close" width="16" height="16" viewBox="0 0 16 16" fill="none"
            ...
            <g clip-path="url(#clip0_97_877)">
                <path
                    ...
                    fill="#fff" stroke="rgba(0,0,0,0.3)" stroke-width="1"/>
            </g>
            <defs>
