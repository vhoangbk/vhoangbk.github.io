...
function processFilenameTemplate(result, options, filenameTemplate) {
  if (!result.info[isFilenameProcessed] && typeof filenameTemplate !== "undefined" && typeof options.generateFilename === "function") {
    result.filename = options.generateFilename(filenameTemplate, {
      filename: result.filename
    });
    result.filename = result.filename.replaceAll(/\[width\]/gi, result.info.width).replaceAll(/\[height\]/gi, result.info.height);
