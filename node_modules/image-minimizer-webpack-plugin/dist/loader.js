...
async function loader(content) {
  ...
  if (this._module?.resourceResolveData?.encodedContent) {
    const isBase64 = /^base64$/i.test(/** @type string */
    this._module.resourceResolveData.encoding);
    this._module.resourceResolveData.encodedContent = isBase64 ? output.data.toString("base64") : encodeURIComponent(output.data.toString("utf8")).replaceAll(/[!'()*]/g, character => `%${/** @type {number} */character.codePointAt(0).toString(16)}`);
  } else {
