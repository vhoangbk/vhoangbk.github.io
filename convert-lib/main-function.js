...
async function executeCommand(cmd, cmd_data, callback) {
    ...
    var postObj = {
        ...
        wasm_url: '/convert-lib/ffmpeg-st-gpl.wasm'
    }
                    ...
                    if (intent.data.cmd == CMD_PERFORM_CONVERT) {
                        ...
                        const updateOutputUrl = async function (stream_index, segment_index, url) {
                            ...
                            if (stream_index >= 0 && segment_index >= 0) {
                                ...
                                console.log('Conversion finished. Output file info:', result);
                        ...
                        if (stream_index == 0) {
                            ...
                            console.log(`Progress: ${totalPercentage.toFixed(2)}%, Time left: ${timeLeft.toFixed(2)} seconds`);
