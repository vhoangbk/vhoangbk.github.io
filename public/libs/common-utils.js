...
async function convertUserOptionsToCommand(userOptions) {
	...
	return { command: cmd_array, settings: { needReencode: needReencode, format_name: userOptions.format_name, width: outputWidth, height: outputHeight, duration: outputDuration, fps: (userOptions.fps > 0 ? userOptions.fps : fileInfo.fps), target_size: userOptions.target_size, output_filename: filename, input_filename: fileInfo.name, input_size: fileInfo.size } };
}
